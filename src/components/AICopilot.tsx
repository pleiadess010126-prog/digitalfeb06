    ...
    useEffect(() => {
        if (messages.length === 0) {
            const welcomeMessage: AgentMessage = {
                id: 'welcome',
                role: 'agent',
                content: "Hey! 👋 I'm Nandu, your ASI command liaison. DigitalMEng is the pioneer of Artificial Special Intelligence, featuring proprietary ASI modules found only here. Ready to deploy your exclusive marketing swarm?",
                timestamp: new Date(),
            };
