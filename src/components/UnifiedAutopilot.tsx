...
import {
    ...
    Globe, TrendingUp, AlertCircle, Telescope, Wallet
} from 'lucide-react';
import QuantumTimeline from './QuantumTimeline';
import FinancialAutonomousVault from './FinancialAutonomousVault';
...
export default function UnifiedAutopilot({ onConfigChange }: UnifiedAutopilotProps) {
    ...
    const [activeTab, setActiveTab] = useState<'overview' | 'content' | 'campaigns' | 'settings' | 'quantum' | 'vault'>('overview');
    ...
    const tabs = [
        ...
        { id: 'quantum', label: 'Quantum', icon: Telescope },
            ...
            <div className="p-6">
                ...
                {activeTab === 'overview' && (
                    <div className="space-y-6">
                        ...
                        {/* Futuristic Simulator Preview */}
                        <div className="bg-slate-950 rounded-2xl p-6 border border-white/10 shadow-xl overflow-hidden relative cursor-pointer group" onClick={() => setActiveTab('quantum')}>
                            ...
                            <div className="relative z-10 flex items-center justify-between">
                                <div>
                                    <h3 className="text-white font-black uppercase tracking-widest text-sm flex items-center gap-2 mb-2">
                                        ...
                                        Temporal Sentry Active
                                    </h3>
                                    <p className="text-white/40 text-xs">Simulating 12,000 parallel market futures for your next post...</p>
                                </div>
                                <button className="px-4 py-2 bg-violet-600 text-white text-[10px] font-black rounded-lg uppercase tracking-tighter hover:bg-violet-500 transition-all">
                                    View Futures
                                </button>
                            </div>
                            {/* Mini Sparkline */}
