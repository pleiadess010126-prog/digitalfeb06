...
const PLATFORMS: PlatformConnection[] = [
    ...
    },
    {
        ...
        icon: '💬',
        status: 'disconnected',
        features: ['Official Accounts', 'Moments (Ads)', 'Mini-Apps'],
    ...
    },
    {
        ...
        icon: '🟦',
        status: 'disconnected',
        features: ['Wall posts', 'Community management', 'Video'],
        setupUrl: 'https://vk.com/dev',
    },
    {
        id: 'ftp',
        name: 'FTP/SFTP',
                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
                    <div className="card w-full max-w-lg mx-4 p-6 animate-scale-in">
                        ...
                        <div className="space-y-4">
                            {selectedPlatform.id === 'twitter' ? (
                                <>
                                    <div>
                                        ...
                                        <input type="text" className="input w-full" placeholder="Enter API Key" />
                                    </div>
                                    <div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" className="input w-full" placeholder="Enter Access Token" />
                                        </div>
                                        <div>
                                            <label className="text-white/80 text-sm mb-2 block">Access Token Secret</label>
                                            <input type="password" className="input w-full" placeholder="Enter Secret" />
                                        </div>
                                    </div>
                                    <div>
                                        <label className="text-white/80 text-sm mb-2 block">Bearer Token (for Analytics)</label>
                                        <input type="password" className="input w-full" placeholder="Enter Bearer Token" />
                                    </div>
                                </>
                            ) : selectedPlatform.id === 'linkedin' || selectedPlatform.id === 'tiktok' ? (
                                <>
                                    <div>
                                        <label className="text-white/80 text-sm mb-2 block">API Key</label>
                            ...
                            ) : selectedPlatform.id === 'wechat' ? (
                                <>
                                    <div>
                                        <label className="text-white/80 text-sm mb-2 block">WeChat App ID</label>
                                        <input type="text" className="input w-full" placeholder="e.g. wx1234567890abcdef" />
                                    </div>
                                    <div>
                                        <label className="text-white/80 text-sm mb-2 block">App Secret</label>
                                        <input type="password" className="input w-full" placeholder="Enter App Secret" />
                                    </div>
                                </>
                            ) : selectedPlatform.id === 'vk' ? (
                                <>
                                    <div>
                                        <label className="text-white/80 text-sm mb-2 block">VK Access Token</label>
                                        <input type="password" className="input w-full" placeholder="Enter Service or User Token" />
                                    </div>
                                    <div>
                                        <label className="text-white/80 text-sm mb-2 block">Community / Owner ID</label>
                                        <input type="text" className="input w-full" placeholder="e.g. -12345678" />
                                    </div>
                                </>
