...
export const config = {
    ...
    // Central Marketing Defaults
    marketing: {
        url: 'https://digitalmeng.in',
        supportEmail: 'support@digitalmeng.in',
        hashtags: [
            'DigitalMEng',
            'AIMarketing',
            'SaaS',
        ...
        social: {
            youtube: 'https://youtube.com/@digitalmeng',
            twitter: 'https://twitter.com/digitalmeng',
        }
    }
};
