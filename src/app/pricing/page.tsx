...
const plans = [
    {
        id: 'free',
        name: '15-Day Trial',
        description: 'Try everything free for 15 days',
        price: 0,
        priceYearly: 0,
        popular: false,
        icon: Sparkles,
    ...
    },
    {
        ...
        features: [
            ...
            { text: '2 platforms (WordPress + Instagram)', included: true },
            { text: '2K voice over characters', included: true },
            { text: '2 music tracks/month', included: true },
    ...
    },
    {
        ...
        features: [
            ...
            { text: '20 min AI Video/month', included: true },
            { text: '40K voice over characters', included: true },
            ...
            { text: 'Private BYO Cloud Support', included: true },
    ...
    },
    {
        ...
        features: [
            ...
            { text: '60 min AI Video/month (fair-use)', included: true },
            { text: '150K voice over characters', included: true },
            { text: 'AI-generated custom music', included: true },
            { text: 'Custom AI models', included: true },
            { text: 'White-label & custom branding', included: true },
            { text: 'Private BYO Cloud (Unlimited)', included: true },
                        ...
                        <table className="w-full">
                            ...
                            <tbody>
                                {[
                                    ...
                                    { feature: 'DigitalMEng Managed Cloud', values: ['Included', 'Included', 'Included', 'Included', 'Included', 'Included'] },
                                    { feature: 'Private BYO Cloud Support', values: ['—', '—', '—', '—', 'Full Support', 'Priority Support'] },
                                    ...
                                    { feature: 'Multi-language Support', values: ['—', '2 languages', '5 languages', '10 languages', '20+ languages', '44 languages'] },
                                    { feature: '🇮🇳 Indian Languages', values: ['—', 'Hindi only', 'Hindi only', 'Hindi + 2', 'Hindi + 5', 'All 13'] },
                                    { feature: 'Regional Targeting', values: ['—', '—', 'Basic', 'Standard', 'Advanced', 'Full 190+ regions'] },
                                    { feature: 'AI Quality Level', values: ['Basic', 'Basic', 'Good', 'Good', 'Excellent', 'Excellent + Review'] },
                    ...
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                        <div>
                            ...
                            <p className="text-slate-600 mb-6">
                                Enterprise plan unlocks all major Indian regional languages for true nationwide reach.
                            </p>
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-2 mb-6">
                                {[
                                    { name: 'Hindi', region: 'UP, MP, Bihar' },
                                    { name: 'Tamil', region: 'Tamil Nadu' },
                                    { name: 'Telugu', region: 'AP, Telangana' },
                                    { name: 'Kannada', region: 'Karnataka' },
                                    { name: 'Malayalam', region: 'Kerala' },
                                    { name: 'Bengali', region: 'West Bengal' },
                                    { name: 'Marathi', region: 'Maharashtra' },
                                    { name: 'Gujarati', region: 'Gujarat' },
                                    { name: 'Punjabi', region: 'Punjab' },
                                    { name: 'Odia', region: 'Odisha' },
                                    { name: 'Assamese', region: 'Assam' },
                                    { name: 'Urdu', region: 'UP, J&K' },
                                    { name: 'Bhojpuri', region: 'Bihar, UP' },
                                ].map(lang => (
                                    <div key={lang.name} className="px-3 py-2 bg-white/70 rounded-lg text-sm">
                                        <span className="font-medium text-slate-800">{lang.name}</span>
                                        <span className="text-slate-500 text-xs block">{lang.region}</span>
                                    </div>
                                ))}
                            </div>
                            <div className="flex flex-wrap gap-2">
                                <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium">🟢 Hindi - Excellent AI</span>
                                <span className="px-3 py-1 bg-amber-100 text-amber-700 rounded-full text-xs font-medium">🟠 Regional - Moderate AI</span>
                            </div>
                        </div>
                        <div className="text-center">
                            <div className="text-5xl md:text-6xl font-bold text-orange-600 mb-2">500M+</div>
                            <p className="text-slate-600 mb-4">Additional audience reach with Indian languages</p>
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/70 rounded-full text-sm text-slate-600 mb-4">
                                <Globe className="w-4 h-4" />
                                190+ regions with localized content
                            </div>
                            <div className="mt-4">
                                <Link
